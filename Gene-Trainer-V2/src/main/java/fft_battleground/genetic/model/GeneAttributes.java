		...
		UserSkillGeneAttributes, BetGeneAttributes, MissingGeneAttributes  
{
	...
	public GeneAttributeOutput getGeneAttributeStringMap() {
		Map<String, Double> geneAttributeNameValueMap = this.geneAttributes.keySet().stream().collect(Collectors.toMap(this.idNameMap::get, this.geneAttributes::get));
...
class GeneAttributeOutput {
	private List<GenericPairing<String, Double>> geneAttributes;
}
